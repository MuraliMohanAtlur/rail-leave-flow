      ...
      <div className="border-t border-sidebar-border p-4">
        <div className="flex items-center gap-3">
            ...
            <DropdownMenuTrigger asChild>
              <Avatar className="h-9 w-9 cursor-pointer">
                <AvatarFallback className="bg-sidebar-primary text-sidebar-primary-foreground text-xs">
                  {user?.name?.slice(0, 2).toUpperCase() || "TI"}
                </AvatarFallback>
              </Avatar>
            </DropdownMenuTrigger>
          ...
          <div className="min-w-0 flex-1">
            <div className="text-sm font-semibold truncate">{user?.name || "Traffic Inspector"}</div>
            <div className="text-xs text-sidebar-foreground/60 truncate">Traffic Inspector{user?.stationName ? ` - ${user.stationName}` : ""}</div>
          </div>
        </div>
      </div>
    </div>
